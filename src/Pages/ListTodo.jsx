        ...
        <VStack space={2} w="100%" mb="4">
          ...
          <View bg="primary.100" borderRadius="10" p="2">
              <Flex direction="row"  w="100%">
                ...
                <Flex direction="column" w="20%">
                  <Button bg="primary.300" px="1" mb="2" color="white">Study</Button>
          ...
          <View bg="success.100" borderRadius="10" p="2">
              <Flex direction="row"  w="100%">
                ...
                <Flex direction="column" w="30%">
                  <Button bg="danger.300" px="1" mb="2" style={{borderRadius: 10,}} >Home Work</Button>
                  <Button bg="success.300" size="50" style={{borderRadius: 50}}>   </Button>
                </Flex>
              </Flex>
          </View>
          ...
          <View bg="danger.100" borderRadius="10" p="2">
              <Flex direction="row"  w="100%">
                ...
                <Flex direction="column" w="20%">
                  <Button bg="primary.300" px="1" mb="2" >Study</Button>
                  <Button bg="success.300" size="50" style={{borderRadius: 50}}>   </Button>
                </Flex>
              </Flex>
          </View>
